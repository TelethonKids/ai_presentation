...
+ **Types of decisions:**
  ...
  + How should we handle any model complexities?
...
- You should be able to verify the AI output is true/accurate with a reasonable and responsible degress of certainty. 
